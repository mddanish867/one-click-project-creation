    ...
    <section className="py-20 bg-black text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 max-w-3xl mx-auto relative">
          ...
          <div className="absolute top-6 left-6 w-0.5 h-calc bg-green-500 -z-10" style={{ height: 'calc(100% - 60px)' }}></div>
          
          {steps.map((step, index) => (
            <div key={index} className="relative flex items-start mb-16 last:mb-0">
              {/* Number Circle */}
              <div className="flex-shrink-0 w-12 h-12 bg-black border-2 border-green-500 rounded-full flex items-center justify-center text-green-400 font-bold z-10">
                {index + 1}
              </div>
