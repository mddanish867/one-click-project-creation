...
export default function LearnMorePage() {
  ...
  const resources = [
    ...
    },
    {
      ...
      icon: <Video className="w-12 h-12 text-pink-600" />,
      link: "#"
    },
    {
      title: "Case Studies",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h1 className="text-5xl md:text-7xl font-thin tracking-tight mb-8">
              Discover
              <span className="block mt-2 font-light text-pink-600">ScaffoldX</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
            {resources.map((resource, index) => (
              <div key={index} className="p-8 border border-gray-800 hover:border-pink-600/50 transition-all duration-500 group">
                ...
                <a href={resource.link} className="block w-full px-6 py-3 bg-pink-600 text-black text-sm tracking-wider hover:bg-pink-400 transition-colors duration-300 text-center group">
                  EXPLORE
