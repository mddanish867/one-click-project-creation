          ...
          <div className="bg-black/30 border border-gray-800 p-8 backdrop-blur-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-right">
                <a href="/login-otp" className="text-sm text-pink-600 hover:text-pink-400 transition-colors">
                  Login with OTP
                </a>
              </div>
              {/* Forgot Password Link */}
              <div className="text-right">
                <a href="/forgot-password" className="text-sm text-pink-600 hover:text-pink-400 transition-colors">
                  Forgot password?
                </a>
              </div>
              ...
              <div className="text-center text-sm text-gray-400">
                ...
                <a href="/signup" className="text-pink-600 hover:text-pink-400 transition-colors">
                  Create one
                </a>
              </div>
            </form>
